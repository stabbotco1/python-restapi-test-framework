...
class Comments:
    ...
    # Comments library that contains all the tests for the Comments module in a single place
    # define properties that will always be the same for Comments
    # this provides a single point of control for the comments endpoints
